...
module Neo
  ...
  module Color
    ...
    def mask(string)
      # "\e[38;255;60m" + string
      "\e[38;5;15;48;5;15m #{string}"  + color(COLORS[:clear])
    end
...
ENDTEXT
    ...
    def guide_through_error
      ...
      puts "(select text below to see answer)"
      puts Color.mask(indent(failure.message).join)
      puts
      puts Color.clear("Please meditate on the following code:")
